...
- Open the pull request the way the project asks.

## Report

- What changed, and where it sits in the project's architecture.
- The proof: the gate command, and what it actually printed.
- The rules that shaped your approach, named.
